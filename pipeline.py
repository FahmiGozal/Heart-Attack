...
num_preproc_2 = pipeline.Pipeline(steps=[('num_cont_scaler', preprocessing.StandardScaler()), ('num_cont_imputer', impute.SimpleImputer(missing_values=-99999, strategy='mean'))])
num_preproc_3 = pipeline.Pipeline(steps=[('num_float_imputer', impute.SimpleImputer(missing_values=-99999, strategy='constant', fill_value=-1))])
